...
<body class="pc-fb-font" bgcolor="#f4f4f4"
    style="background-color: #f4f4f4; width: 100% !important; Margin: 0 !important; padding: 0; line-height: 1.5; -webkit-font-smoothing: antialiased; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td align="center" valign="top">
                                                    <img src=""
                                                        alt="" height="" width="100%" class="emailImage" />
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table> --}}
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td class="pc-cta-box-in"
                                                                                    style="vertical-align: top; padding: 0px 30px 32px;"
                                                                                    valign="top">
                                                                                    <table class="pc-cta-s1" border="0"
                                                                                        ...
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td style="vertical-align: top; height: 35px; font-size: 10px; line-height: 10px;"
                                                                                                    valign="top">&nbsp;
                                                                                                </td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td class="pc-cta-text pc-fb-font info-message"
                                                                                                    ...
                                                                                                    <p>La solicitud de reservacion
                                                                                                        ...
                                                                                                        A sido aceptada con fecha y hora:
